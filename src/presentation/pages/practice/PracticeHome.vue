<template>
  <div class="page">
          ...
          <div class="subject-card" v-for="subject in SubjectsOptions" :key="subject.name"
            ...
            <div v-if="expandedSubject === subject.name" class="subject-expanded">
              ...
              <div class="action-row">
                <button v-if="hasProgress(subject)" class="new-btn" @click.stop="newQuizWith(subject)"
                  :disabled="store.loading">{{ t('new')
                  }}</button>
    ...
    <PracticeConfig :visible="showPracticeSetting" :subject="selectedSubject" @close="showPracticeSetting = false"
