const translations = {
  en: {
    ...
    myExams: "My Exams",
    viewAll: "View All",
    noExamHistory: "No exam records yet",
    ...
    public: "Public",
    joinExam: "Join Exam",
    joinExamHint: "Enter the exam ID and password to join the exam.",
    examId: "Exam ID",
    examPassword: "Password",
    examIdPlaceholder: "Enter exam ID",
    examPasswordPlaceholder: "Enter password (optional)",
    examIdRequired: "Please enter the exam ID",
    ...
    sortMode: "Sort Mode",
    sortModeDesc: "Choose the order questions appear",
    practiceMode: "Practice Mode",
    answerDisplay: "Answer Display",
    displayMode: "Display Mode",
    displayModeDesc: "Choose how answers are displayed",
    ...
    passRate: "Pass Rate (%)",
    confirmExitCreate: "Are you sure to exit? Unsaved changes will be lost.",
    total: "Total",
    customSelect: "Custom Select",
    presetBasicCollection: "Basic Collection",
    presetAirportControl: "Airport Control",
    presetApronControl: "Apron Control",
    apply: "Apply",
  ...
  zh: {
    ...
    public: "公开",
    joinExam: "参加考试",
    joinExamHint: "输入试卷 ID 和密码加入考试。",
    examId: "试卷 ID",
    examPassword: "考试密码",
    examIdPlaceholder: "请输入试卷 ID",
    examPasswordPlaceholder: "请输入密码（选填）",
    examIdRequired: "请输入试卷 ID",
    examNotFound: "试卷不存在",
    wrongPassword: "密码错误",
    cancel: "取消",
    examPaper: "考试试卷",
    ...
    questionOrder: "习题顺序",
    sortMode: "题目顺序",
    sortModeDesc: "选择题目出现的顺序",
    practiceMode: "练习模式",
    answerDisplay: "答案显示方式",
    displayMode: "作答显示",
    displayModeDesc: "按照需求检查答案",
    autoJump: "答对自动跳转下一题",
    autoJumpDesc: "减少操作步骤，提升刷题效率",
    showImmediately: "自动检查",
    showOnDemand: "手动检查",
    startPractice: "开始练习",
    reviewMode: "背题模式",
    reviewModeDesc: "同步显示题干与答案",
    answerMode: "答题模式",
    answerModeDesc: "作答后检查答案",
    ...
    examInfo: "考试信息",
    examName: "考试名称",
    examNamePlaceholder: "请输入考试名称",
    visibility: "生效范围",
    passwordPlaceholder: "设置访问密码",
    passRate: "得分率 (%)",
    confirmExitCreate: "确定要退出吗？已填写的内容将丢失。",
    total: "共",
    customSelect: "自定义选择",
    presetBasicCollection: "基础合集",
    presetAirportControl: "机场管制",
    presetApronControl: "机坪管制",
    apply: "应用",
    configurePreset: "配置预设",
  },
};
