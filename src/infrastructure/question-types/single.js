const capabilities = { canAutoCheck: true, needsManualCheck: false, canShuffle: true, isComposite: false }
...
export default { type: 'single', capabilities, component: null, checkAnswer, pack, unpack }
